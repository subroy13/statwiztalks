...
\begin{minipage}[t]{0.72\textwidth}
    ...
    { 
        ...
        \begin{minipage}{0.4\textwidth}
            ...
            \icon{Phone}{11}{(+1) (314)745-2968}\vspace{-1.5mm}\\
            \icon{Envelope}{11}{\href{mailto:roy.s@wustl.edu}{roy.s@wustl.edu}}\vspace{-1.5mm}\\
        \end{minipage}
...
\begin{itemize}[noitemsep, leftmargin=*]
    \item Robust statistical inference, divergences, minimum divergence estimation.
    \item Dependent data analysis, spatial analysis, spatiotemporal analysis.
    \item Statistical methods for Deep learning, AI safety, and trustworthiness.
...
\begin{entrylist}
    ...
    {\small\textbf{Research Mentor:} Prof. Debashis Mondal.}
    % {\vspace{-7pt}\small
    % \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=10pt]
    %     \item \textbf{Courses taught:} SDS 4010 Probability (Fall 2025), SDS 5140 Advanced Linear Models (Spring 2026).
    % \end{itemize}
    % }
    \entry
    {July, 2022\\ - June, 2025}
    ...
    {\vspace{-7pt}\small
        \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=10pt]
            \item Continuous system improvement, research, and novel technology development across the company.
...
\begin{enumerate}
    \item \textbf{Roy, S.}, Sarkar, A., Ghosh, A., \& Basu, A. (2026). Asymptotic Breakdown Point Analysis for a General Class of Minimum Divergence Estimators. \emph{Bernoulli}, 32(1), 698-722. \href{https://projecteuclid.org/journals/bernoulli/volume-32/issue-1/Asymptotic-breakdown-point-analysis-for-a-general-class-of-minimum/10.3150/25-BEJ1876.short}{[Link]}.
...
\textbf{Preprints}
\begin{enumerate}
    \item \textbf{Roy, S.}, Ghosh, A., \& Basu, A. (2025). Robust Rank Estimation for Noisy Matrices. \emph{arXiv preprint} arXiv:2510.19583. \href{https://arxiv.org/abs/2510.19583}{[Link]}.
    \item Bonnerjee, S., Karmakar, S., \& \textbf{Roy, S.} (2025). WISER: Segmenting watermarked region-an epidemic change-point perspective. \emph{arXiv preprint} arXiv:2509.21160. \href{https://arxiv.org/abs/2509.21160}{[Link]}.
...
\begin{enumerate}
    \item Invited lecture for \textbf{Statistics \& Data Seminar Series, 2026} at the \textbf{Mathematics Department, Saint Louis University}.\\
    \emph{Title:} Localized Detection of Authenticity of Mixed LLM-Human Generated Texts.
    \item Invited lecture for \textbf{Graduate Student Seminar Series, 2025} at the \textbf{Department of Statistics and Data Science, Washington University in St. Louis}.\\
    \emph{Title:} Localized Detection of Authenticity in Mixed Source Texts via Epidemic Change-point Perspective.
...
\begin{entrylist}
    ...
    {Robust Statistics}
    {Indian Statistical Institute, Kolkata}
    {\small Invited Guest Lecture on ``\emph{A review of Robust Location and Scatter estimators.}''}
    \vspace*{-20pt}
    \entry
    {Summer, 24}
    ...
    \entry
    {Fall, 25}
    {SDS 4010 Introduction to Probability}
    {Washington University in St. Louis}
    {}
    \vspace*{-20pt}
    \entry
    {Spring, 26}
    {SDS 5140 Advanced Linear Models}
    {Washington University in St. Louis}
    {}
    % \vspace*{-20pt}
    % \entry
...
% ---------------------------
% Projects, Tools, Packages
% --------------------------
\pagebreak
\cvsect{Projects, Software and Packages}
\begin{entrylist}
    \vspace{-10pt}
    \entry
    {2025}
...
\begin{entrylist}
    ...
    {Institute of Mathematics and Application, Bhubaneshwar}
    {}
\end{entrylist}
...
% % \vspace{-6pt}
% \begin{itemize}
%     \item \textbf{Ayaendranath Basu.} Professor, Indian Statistical Institute, Kolkata.\\ 
%     \emph{Email:} \href{mailto:ayanbasu@isical.ac.in}{ayanbasu@isical.ac.in}
%     \item \textbf{Soudeep Deb.} Associate Professor, Indian Institute of Management, Bangalore.\\
%     \emph{Email:} \href{mailto:soudeep@iimb.ac.in}{soudeep@iimb.ac.in}
%     \item \textbf{Diganta Mukherjee.} Professor, Indian Statistical Institute, Kolkata. \\
%     \emph{Email:} \href{mailto:diganta@isical.ac.in}{diganta@isical.ac.in}
%     \item \textbf{Abhik Ghosh.}  Associate Professor, Indian Statistical Institute, Kolkata.\\
%     \emph{Email:} \href{mailto:abhik.ghosh@isical.ac.in}{abhik.ghosh@isical.ac.in}
%     \item \textbf{Vijay Krishna.} CEO, SysCloud Inc.\\
%     \emph{Email:} \href{mailto:vijay@syscloudsoftware.com}{vijay@syscloudsoftware.com}
% \end{itemize}
...
% \vspace{1cm}
\textit{I certify that the information provided above is true and accurate to the best of my knowledge\footnote{Last updated on Feb, 2026}}
\begin{flushright}
